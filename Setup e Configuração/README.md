...
12. Execute o comando `git clone https://github.com/vamperst/senai-infra-as-code-terraform.git` para clonar o repositório com os exercicios.
13. Execute o comando `cd senai-infra-as-code-terraform/` para entrar na pasta criada pelo git
