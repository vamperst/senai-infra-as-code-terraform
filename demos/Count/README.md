1. Execute o comando `cd ~/environment/senai-infra-as-code-terraform/demos/Count/` para entrar no diretório do exercício.
...
7. Agora vá até o arquivo `main.tf`(senai-infra-as-code-terraform/demos/Count) pelo IDE e altere o valor do count para 3
